...
$DB_CONFIG = $ROOT . '/config/credentials.php';   // untracked — safe from Git deploys
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        try {
            ...
            // Write config/credentials.php (untracked: Git deploys never touch it).
            $config = "<?php\n"
                . "// Auto-generated by install.php. Keep this file private; do not commit it.\n"
            ...
            if (@file_put_contents($DB_CONFIG, $config) === false) {
                $errors[] = 'Tables created, but config/credentials.php is not writable. '
                    . 'Set the config/ folder permissions to 755 and retry.';
            } else {
